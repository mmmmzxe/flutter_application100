...
import 'package:flutter_application100/padges/products.dart';
        ...
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  Icon(CupertinoIcons.cart_badge_plus,size: 28,),
                  SizedBox(width: 10,),
                ...
                children: <Widget>[
                  ...
                  Hero(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(image: AssetImage(items[index]['img']),)
                    ),
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(items[index]['name'],style: TextStyle(
                        fontSize: 15,color: Color.fromARGB(132, 104, 101, 101),
                        
                      ),),
                      SizedBox(height: 20,),
                      Row(
                        children: <Widget>[
                          Text(items[index]['p_promotion_price'].toString()+" \$",style: TextStyle(
                        fontSize: 16,
                      ),),
                      SizedBox(width: 20,),
                      Text(items[index]['p_price'].toString()+" \$",style: TextStyle(
                        fontSize: 17,
                        color: warning,
                        fontWeight: FontWeight.w500,
                      ...
                      SizedBox(width: 180,),
                       Icon(CupertinoIcons.cart_badge_plus, color: Colors.pink,)
                        ],
                      )
                    ],
                  )
